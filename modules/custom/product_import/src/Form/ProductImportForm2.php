...
class ProductImportForm2 extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['example_excel_file'] = [
      '#type' => 'markup',
      '#markup' => '<a href="/sites/default/files/classic_product.xlsx" download>Download Excel</a>',
      '#attributes' => ['class' => ['btn-primary']],
    ];
    $form['submit'] = [
      '#type' => 'submit',
      '#value' => $this->t('Import products classic'),
      '#button_type' => 'primary',
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    foreach($rows as $key=>$value){
      if($key>0 && !empty($value[0])){   
        $operations[] = ['Upload_product_classic',
        [$value],
        ];          
      }
		}
